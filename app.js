...
function toggleKraken() {
    if (kraken.innerHTML === 'Terminal Game - The Kraken') {
        kraken.innerHTML = '<img src="./resources/images/krakenGame.png" style="max-width: 300px; height: auto;">'
    } else {
...
function toggleVenue() {
    if (venue.innerHTML === 'San Diego Music Venue Finder') {
        venue.innerHTML = '<img src="./resources/images/sdLiveMusic.png" style="max-width: 300px; height: auto;">'
    } else {
...
function toggleCPU() {
    if (cpu.innerHTML === 'CPU Simulator') {
        cpu.innerHTML = '<img src="./resources/images/cpuSimulator.png" style="max-width: 300px; height: auto;">'
    } else {
...
function toggleHoroscope() {
    if (horoscope.innerHTML === 'Javascript Horoscope Generator') {
        horoscope.innerHTML = '<img src="./resources/images/horoscope.png" style="max-width: 300px; height: auto;">'
    } else {
